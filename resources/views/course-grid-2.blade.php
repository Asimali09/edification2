		...
		<div class="row">
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img  class="card-img-top" src="images/NED-1.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">NED University Of Engineering </h5>
				  
				  <p class="card-text">The NED University  is a public university located in Karachi.The oldest engineering university.</p>
		  ...
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img style="height: 160px; " class="card-img-top" src="images/baqai.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">Baqai Medical University, Karachi
				</h5>
				  <p class="card-text">Baqai Medical University is a higher education institution located on M-9, Super Highway, Karachi, Pakistan</p>
				  <a href="http://www.baqai.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
				</div>
			  </div>
		  </div>
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img style="height: 160px; " class="card-img-top" src="images/dawood.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">Dawood University Of Engineering</h5>
				  <p class="card-text">The Dawood University of Engineering and Technology is a public university located in Karachi.</p>
				  <a href="https://www.duet.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
				</div>
			  </div>
		  </div>
...
<br>
	  ...
	  <div class="container">
		<div class="row">
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img style="height: 160px; " class="card-img-top" src="images/greenwich.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">Greenwich University, Karachi</h5>
				  <p class="card-text">  Greenwich University  is one of the leading business universities of Pakistan</p>
				  <a href="https://www.greenwich.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
				</div>
			  </div>
		  </div>
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img style="height: 160px; " class="card-img-top" src="images/karachi.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">University of Karachi</h5>
				  <p class="card-text">The University of Karachi is a public research university located in Karachi, Sindh, Pakistan. </p>
				  <a href="https://www.uok.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
				</div>
			  </div>
		  </div>
		  <div class="col-sm">
			<div class="card" style="width: 18rem;">
				<img style="height: 160px; " class="card-img-top" src="images/ziauddin.jpg" alt="Card image cap">
				<div class="card-body">
				  <h5 class="card-title">Ziauddin University, Karachi</h5>
				  <p class="card-text">The Ziauddin University; abbreviated as ZU is a private university located in Karachi.</p>
				  <a href="https://www.zu.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
				</div>
			  </div>
		  </div>
		</div>
	  ...
	  <br>
			...
			<div class="container">
			  <div class="row">
				<div class="col-sm">
				  <div class="card" style="width: 18rem;">
					  <img style="height: 160px; " class="card-img-top" src="images/agha.jpg" alt="Card image cap">
					  <div class="card-body">
						<h5 class="card-title">Aga Khan University, Karachi</h5>
						<p class="card-text">Aga Khan University is a non-profit institution and an agency of the Aga Khan Development Network.</p>
						<a href="https://www.aku.edu/Pages/home.aspx" target="_blank" class="btn btn-primary">More Information</a>
					  </div>
					</div>
				</div>
				<div class="col-sm">
				  <div class="card" style="width: 18rem;">
					  <img style="height: 160px; " class="card-img-top" src="images/sirsyed.jpg" alt="Card image cap">
					  <div class="card-body">
						<h5 class="card-title">Sir Syed University of Engineering </h5>
						<p class="card-text">Sir Syed University  is a private research university located in the urban area of Karachi.</p>
						<a href="https://www.ssuet.edu.pk/" target="_blank" class="btn btn-primary">More Information</a>
					  </div>
					</div>
				</div>
				<div class="col-sm">
				  <div class="card" style="width: 18rem;">
					  <img style="height: 160px; " class="card-img-top" src="images/bahria.jpg" alt="Card image cap">
					  <div class="card-body">
						<h5 class="card-title">Bahria University</h5>
						<p class="card-text">Bahria University is a Public Sector University.It plays a major role in grooming future leaders</p>
